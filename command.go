...
// Command represents a command from a client to an PDMQ daemon
type Command struct {
	Name   []byte
	Params [][]byte
	Body   []byte
...
//
// See http://pdmq.io/clients/tcp_protocol_spec.html#identify for information
...
// Register creates a new Command to add a topic/channel for the connected pdmqd
...
// UnRegister creates a new Command to remove a topic/channel for the connected pdmqd
...
// client would like to start a close cycle.  pdmqd will no longer
