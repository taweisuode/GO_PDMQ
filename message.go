...
// Finish sends a FIN command to the pdmqd which
// sent this message
...
// Touch sends a TOUCH command to the pdmqd which
// sent this message
...
// Requeue sends a REQ command to the pdmqd which
...
// RequeueWithoutBackoff sends a REQ command to the pdmqd which
// sent this message, using the supplied delay.
//
